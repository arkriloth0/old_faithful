...
Based on Gaussian mixture model analysis of the old faithful dataset, there are two clusters of eruptions. The first cluster is of short waiting time and eruption duration, while the second cluster has long waiting time and eruption duration.
